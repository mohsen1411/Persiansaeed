package com.develope.persiancalendar.adapter;
...
import com.develope.persiancalendar.view.fragment.MonthFragment;
...
public class MonthAdapter extends RecyclerView.Adapter<MonthAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
           // Typeface p =Typeface.createFromAsset(itemView.getContext().getAssets(),"fonts/");
            num = (TextView) itemView.findViewById(R.id.num);
            num.setShadowLayer(1, 2, 1,  Color.BLACK);
